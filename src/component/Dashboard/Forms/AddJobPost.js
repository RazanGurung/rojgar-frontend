...
function AddJobpost() {
    ...
    const jobPost=()=>{
        ...
        axios.post("https://rojgar-backend.herokuapp.com/job/post/"+id, data).then((res)=>{
    ...
    return (
        <div>
            ...
            <Button onClick={jobPost} className ="register__button btn-lg btn-block" style={{marginTop:"20px",marginBottom:"20px"}} id= "submit" > Post Job</Button>
        </div>
    )
}
